...
export const seedCupCompetitions = mutation({
  ...
  handler: async (ctx) => {
    ...
    // 3. Equipes da Champions League (Lista Oficial dos 36 Clubes Participantes)
    const uclTeamsDefs = [
      { name: "AEK Athens", shortName: "AEK", code: "AEK", externalId: 554, logoUrl: "https://media.api-sports.io/football/teams/554.png" },
      { name: "LASK", shortName: "LASK", code: "LASK", externalId: 1043, logoUrl: "https://media.api-sports.io/football/teams/1043.png" },
      { name: "Club Brugge", shortName: "Club Brugge", code: "CLU", externalId: 569, logoUrl: "https://media.api-sports.io/football/teams/569.png" },
      { name: "Aston Villa", shortName: "Aston Villa", code: "AVL", externalId: 66, logoUrl: "https://media.api-sports.io/football/teams/66.png" },
      { name: "Borussia Dortmund", shortName: "Dortmund", code: "BVB", externalId: 165, logoUrl: "https://media.api-sports.io/football/teams/165.png" },
      { name: "Villarreal", shortName: "Villarreal", code: "VIL", externalId: 533, logoUrl: "https://media.api-sports.io/football/teams/533.png" },
      { name: "Porto", shortName: "Porto", code: "POR", externalId: 212, logoUrl: "https://media.api-sports.io/football/teams/212.png" },
      { name: "Manchester City", shortName: "Man City", code: "MCI", externalId: 50, logoUrl: "https://media.api-sports.io/football/teams/50.png" },
      { name: "Lille", shortName: "Lille", code: "LIL", externalId: 79, logoUrl: "https://media.api-sports.io/football/teams/79.png" },
      { name: "Real Betis", shortName: "Real Betis", code: "BET", externalId: 543, logoUrl: "https://media.api-sports.io/football/teams/543.png" },
      { name: "Real Madrid", shortName: "Real Madrid", code: "RMA", externalId: 541, logoUrl: "https://media.api-sports.io/football/teams/541.png" },
      { name: "Inter de Milão", shortName: "Inter", code: "INT", externalId: 505, logoUrl: "https://media.api-sports.io/football/teams/505.png" },
      { name: "Barcelona", shortName: "Barcelona", code: "BAR", externalId: 529, logoUrl: "https://media.api-sports.io/football/teams/529.png" },
      { name: "Feyenoord", shortName: "Feyenoord", code: "FEY", externalId: 247, logoUrl: "https://media.api-sports.io/football/teams/247.png" },
      { name: "Stuttgart", shortName: "Stuttgart", code: "STU", externalId: 172, logoUrl: "https://media.api-sports.io/football/teams/172.png" },
      { name: "Viking Stavanger", shortName: "Viking", code: "VIK", externalId: 329, logoUrl: "https://media.api-sports.io/football/teams/329.png" },
      { name: "Liverpool", shortName: "Liverpool", code: "LIV", externalId: 40, logoUrl: "https://media.api-sports.io/football/teams/40.png" },
      { name: "Atlético de Madrid", shortName: "Atlético Madrid", code: "ATM", externalId: 530, logoUrl: "https://media.api-sports.io/football/teams/530.png" },
      { name: "Paris Saint-Germain", shortName: "PSG", code: "PSG", externalId: 85, logoUrl: "https://media.api-sports.io/football/teams/85.png" },
      { name: "Slovan Bratislava", shortName: "Slovan", code: "SLO", externalId: 1988, logoUrl: "https://media.api-sports.io/football/teams/1988.png" },
      { name: "Napoli", shortName: "Napoli", code: "NAP", externalId: 492, logoUrl: "https://media.api-sports.io/football/teams/492.png" },
      { name: "Arsenal", shortName: "Arsenal", code: "ARS", externalId: 42, logoUrl: "https://media.api-sports.io/football/teams/42.png" },
      { name: "Sporting CP", shortName: "Sporting", code: "SCP", externalId: 228, logoUrl: "https://media.api-sports.io/football/teams/228.png" },
      { name: "Galatasaray SK", shortName: "Galatasaray", code: "GAL", externalId: 553, logoUrl: "https://media.api-sports.io/football/teams/553.png" },
      { name: "Fenerbahçe", shortName: "Fenerbahçe", code: "FEN", externalId: 611, logoUrl: "https://media.api-sports.io/football/teams/611.png" },
      { name: "Roma", shortName: "Roma", code: "ROM", externalId: 497, logoUrl: "https://media.api-sports.io/football/teams/497.png" },
      { name: "PSV Eindhoven", shortName: "PSV", code: "PSV", externalId: 248, logoUrl: "https://media.api-sports.io/football/teams/248.png" },
      { name: "Shakhtar Donetsk", shortName: "Shakhtar", code: "SHA", externalId: 550, logoUrl: "https://media.api-sports.io/football/teams/550.png" },
      { name: "Como", shortName: "Como", code: "COM", externalId: 523, logoUrl: "https://media.api-sports.io/football/teams/523.png" },
      { name: "RB Leipzig", shortName: "Leipzig", code: "RBL", externalId: 173, logoUrl: "https://media.api-sports.io/football/teams/173.png" },
      { name: "Bayern München", shortName: "Bayern", code: "BAY", externalId: 157, logoUrl: "https://media.api-sports.io/football/teams/157.png" },
      { name: "FK Bodo Glimt", shortName: "Bodø/Glimt", code: "BOD", externalId: 327, logoUrl: "https://media.api-sports.io/football/teams/327.png" },
      { name: "Manchester United", shortName: "Man Utd", code: "MUN", externalId: 33, logoUrl: "https://media.api-sports.io/football/teams/33.png" },
      { name: "Sabah", shortName: "Sabah", code: "SAB", externalId: 7771, logoUrl: "https://media.api-sports.io/football/teams/7771.png" },
      { name: "Slavia Praha", shortName: "Slavia Praha", code: "SLA", externalId: 575, logoUrl: "https://media.api-sports.io/football/teams/575.png" },
      { name: "Lens", shortName: "Lens", code: "RCL", externalId: 116, logoUrl: "https://media.api-sports.io/football/teams/116.png" },
    ];

    const uclTeamMap = new Map<string, Id<"teams">>();
    const allExistingTeams = await ctx.db.query("teams").collect();

    // Restaura Dinamo Zagreb se tiver sido modificado acidentalmente
    const dinamo = allExistingTeams.find((t) => t.name === "Dinamo Zagreb");
    if (dinamo) {
      await ctx.db.patch(dinamo._id, {
        code: "DZG",
        shortName: undefined,
        externalId: 645,
      });
    ...
    // Mapa de aliases para resolução rápida dos clubes
    ...
    const getTeam = (alias: string): Id<"teams"> => {
      const clean = alias.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").trim();
      const id = uclTeamMap.get(alias) || aliasMap.get(alias.toLowerCase()) || aliasMap.get(clean);
      if (!id) throw new Error(`Time não encontrado para alias: ${alias}`);
      return id;
    };

    // Estádios Oficiais Europeus dos 36 Clubes
    const CLUB_STADIUMS: Record<string, { stadium: string; city: string }> = {
      "AEK Athens": { stadium: "OPAP Arena", city: "Atenas (GRE)" },
      "LASK": { stadium: "Raiffeisen Arena", city: "Linz (AUT)" },
      "Club Brugge": { stadium: "Jan Breydelstadion", city: "Bruges (BEL)" },
      "Aston Villa": { stadium: "Villa Park", city: "Birmingham (ING)" },
      "Borussia Dortmund": { stadium: "Signal Iduna Park", city: "Dortmund (ALE)" },
      "Villarreal": { stadium: "Estadio de la Cerámica", city: "Vila-real (ESP)" },
      "Porto": { stadium: "Estádio do Dragão", city: "Porto (POR)" },
      "Manchester City": { stadium: "Etihad Stadium", city: "Manchester (ING)" },
      "Lille": { stadium: "Decathlon Arena - Stade Pierre-Mauroy", city: "Villeneuve-d'Ascq (FRA)" },
      "Real Betis": { stadium: "Estadio Benito Villamarín", city: "Sevilha (ESP)" },
      "Real Madrid": { stadium: "Santiago Bernabéu", city: "Madri (ESP)" },
      "Inter de Milão": { stadium: "San Siro", city: "Milão (ITA)" },
      "Barcelona": { stadium: "Spotify Camp Nou", city: "Barcelona (ESP)" },
      "Feyenoord": { stadium: "Stadion Feijenoord", city: "Roterdã (HOL)" },
      "Stuttgart": { stadium: "MHPArena", city: "Stuttgart (ALE)" },
      "Viking Stavanger": { stadium: "Lyse Arena", city: "Stavanger (NOR)" },
      "Liverpool": { stadium: "Anfield", city: "Liverpool (ING)" },
      "Atlético de Madrid": { stadium: "Riyadh Air Metropolitano", city: "Madri (ESP)" },
      "Paris Saint-Germain": { stadium: "Parc des Princes", city: "Paris (FRA)" },
      "Slovan Bratislava": { stadium: "Štadión Tehelné pole", city: "Bratislava (ESQ)" },
      "Napoli": { stadium: "Stadio Diego Armando Maradona", city: "Nápoles (ITA)" },
      "Arsenal": { stadium: "Emirates Stadium", city: "Londres (ING)" },
      "Sporting CP": { stadium: "José Alvalade", city: "Lisboa (POR)" },
      "Galatasaray SK": { stadium: "RAMS Park", city: "Istambul (TUR)" },
      "Fenerbahçe": { stadium: "Chobani Stadium", city: "Istambul (TUR)" },
      "Roma": { stadium: "Stadio Olimpico", city: "Roma (ITA)" },
      "PSV Eindhoven": { stadium: "Philips Stadion", city: "Eindhoven (HOL)" },
      "Shakhtar Donetsk": { stadium: "Metalist Stadium", city: "Kharkiv (UCR)" },
      "Como": { stadium: "Stadio Giuseppe Sinigaglia", city: "Como (ITA)" },
      "RB Leipzig": { stadium: "Red Bull Arena", city: "Leipzig (ALE)" },
      "Bayern München": { stadium: "Allianz Arena", city: "Munique (ALE)" },
      "FK Bodo Glimt": { stadium: "Aspmyra Stadion", city: "Bodø (NOR)" },
      "Manchester United": { stadium: "Old Trafford", city: "Manchester (ING)" },
      "Sabah": { stadium: "Bank Respublika Arena", city: "Masazır (AZE)" },
      "Slavia Praha": { stadium: "Fortuna Arena", city: "Praga (RTC)" },
      "Lens": { stadium: "Stade Bollaert-Delelis", city: "Lens (FRA)" },
    };
    ...
    for (const clubName of Object.keys(CLUB_STADIUMS)) {
      const st = CLUB_STADIUMS[clubName];
      await getOrCreateStadium(st.stadium, st.city);
    }

    // 4. Limpeza das partidas antigas da Champions League para reinserir o calendário oficial
    ...
    // 5. Partidas Oficiais da Fase de Liga (Rodadas 1 a 4)
    // ----------------------------------------------------
    ...
    for (const m of round1Matches) {
      ...
      const homeTeam = uclTeamsDefs.find((t) => uclTeamMap.get(t.name) === homeId)!;
      const stInfo = CLUB_STADIUMS[homeTeam.name] || { stadium: "Estádio Europeu", city: "Europa" };
      const stadium = await getOrCreateStadium(stInfo.stadium, stInfo.city);
      ...
      await ctx.db.insert("matchStatistics", {
        matchId,
        homePossession: 50 + (m.hs - m.as) * 3,
        awayPossession: 50 - (m.hs - m.as) * 3,
        homeTotalShots: 10 + m.hs * 2,
        awayTotalShots: 7 + m.as * 2,
        homeShotsOnTarget: m.hs + 3,
        awayShotsOnTarget: m.as + 2,
        homeCorners: 5,
        awayCorners: 4,
        homeFouls: 12,
        awayFouls: 13,
        homeYellowCards: 2,
        awayYellowCards: 2,
        homeRedCards: m.events.filter((e) => e.type === "RED_CARD" && e.team === "home").length,
        awayRedCards: m.events.filter((e) => e.type === "RED_CARD" && e.team === "away").length,
        homePasses: 480,
        awayPasses: 450,
        homePassAccuracy: 85,
        awayPassAccuracy: 82,
      ...
      // Eventos (Gols e Cartões Vermelhos)
      for (const ev of m.events) {
        await ctx.db.insert("matchEvents", {
          matchId,
          minute: ev.minute,
    ...
    // ----------------------------------------------------
    // Rodada 2: Agendadas (SCHEDULED)
    const round2Matches = [
      // 13/10/2026
      { home: "Lens", away: "Sporting", time: "13:45", date: "2026-10-13T13:45:00-03:00" },
      { home: "Sabah", away: "Slavia Praha", time: "13:45", date: "2026-10-13T13:45:00-03:00" },
      { home: "Arsenal", away: "Lille", time: "16:00", date: "2026-10-13T16:00:00-03:00" },
      { home: "Atlético Madrid", away: "Man Utd", time: "16:00", date: "2026-10-13T16:00:00-03:00" },
      { home: "Galatasaray", away: "Barcelona", time: "16:00", date: "2026-10-13T16:00:00-03:00" },
      { home: "Inter", away: "Club Brugge", time: "16:00", date: "2026-10-13T16:00:00-03:00" },
      { home: "Leipzig", away: "PSV", time: "16:00", date: "2026-10-13T16:00:00-03:00" },
      { home: "Viking", away: "Bayern", time: "16:00", date: "2026-10-13T16:00:00-03:00" },
      { home: "Villarreal", away: "Napoli", time: "16:00", date: "2026-10-13T16:00:00-03:00" },

      // 14/10/2026
      { home: "Feyenoord", away: "Como", time: "13:45", date: "2026-10-14T13:45:00-03:00" },
      { home: "LASK", away: "Liverpool", time: "13:45", date: "2026-10-14T13:45:00-03:00" },
      { home: "Roma", away: "Real Madrid", time: "16:00", date: "2026-10-14T16:00:00-03:00" },
      { home: "Aston Villa", away: "Fenerbahçe", time: "16:00", date: "2026-10-14T16:00:00-03:00" },
      { home: "Bodø/Glimt", away: "Dortmund", time: "16:00", date: "2026-10-14T16:00:00-03:00" },
      { home: "Man City", away: "PSG", time: "16:00", date: "2026-10-14T16:00:00-03:00" },
      { home: "Real Betis", away: "Porto", time: "16:00", date: "2026-10-14T16:00:00-03:00" },
      { home: "Shakhtar", away: "AEK", time: "16:00", date: "2026-10-14T16:00:00-03:00" },
      { home: "Slovan", away: "Stuttgart", time: "16:00", date: "2026-10-14T16:00:00-03:00" },
    ];
    ...
    // ----------------------------------------------------
    // Rodada 3: Agendadas (SCHEDULED)
    const round3Matches = [
      // 20/10/2026
      { home: "Fenerbahçe", away: "Slavia Praha", time: "13:45", date: "2026-10-20T13:45:00-03:00" },
      { home: "Sabah", away: "Dortmund", time: "13:45", date: "2026-10-20T13:45:00-03:00" },
      { home: "Roma", away: "Slovan", time: "16:00", date: "2026-10-20T16:00:00-03:00" },
      { home: "Porto", away: "PSV", time: "16:00", date: "2026-10-20T16:00:00-03:00" },
      { home: "Liverpool", away: "Villarreal", time: "16:00", date: "2026-10-20T16:00:00-03:00" },
      { home: "Man City", away: "AEK", time: "16:00", date: "2026-10-20T16:00:00-03:00" },
      { home: "PSG", away: "Barcelona", time: "16:00", date: "2026-10-20T16:00:00-03:00" },
      { home: "Napoli", away: "Bodø/Glimt", time: "16:00", date: "2026-10-20T16:00:00-03:00" },
      { home: "Stuttgart", away: "Atlético Madrid", time: "16:00", date: "2026-10-20T16:00:00-03:00" },

      // 21/10/2026
      { home: "Como", away: "Man Utd", time: "13:45", date: "2026-10-21T13:45:00-03:00" },
      { home: "Lille", away: "Galatasaray", time: "13:45", date: "2026-10-21T13:45:00-03:00" },
      { home: "Aston Villa", away: "Viking", time: "16:00", date: "2026-10-21T16:00:00-03:00" },
      { home: "Club Brugge", away: "Lens", time: "16:00", date: "2026-10-21T16:00:00-03:00" },
      { home: "Bayern", away: "Arsenal", time: "16:00", date: "2026-10-21T16:00:00-03:00" },
      { home: "Inter", away: "Shakhtar", time: "16:00", date: "2026-10-21T16:00:00-03:00" },
      { home: "Real Betis", away: "Feyenoord", time: "16:00", date: "2026-10-21T16:00:00-03:00" },
      { home: "Real Madrid", away: "Leipzig", time: "16:00", date: "2026-10-21T16:00:00-03:00" },
      { home: "Sporting", away: "LASK", time: "16:00", date: "2026-10-21T16:00:00-03:00" },
    ];

    for (const m of round3Matches) {
      const homeId = getTeam(m.home);
      const awayId = getTeam(m.away);
      const homeTeam = uclTeamsDefs.find((t) => uclTeamMap.get(t.name) === homeId)!;
      const stInfo = CLUB_STADIUMS[homeTeam.name] || { stadium: "Estádio Europeu", city: "Europa" };
    ...
    // ----------------------------------------------------
    // Rodada 4: Agendadas (SCHEDULED)
    const round4Matches = [
      // 03/11/2026
      { home: "Galatasaray", away: "Stuttgart", time: "14:45", date: "2026-11-03T14:45:00-03:00" },
      { home: "Shakhtar", away: "Sporting", time: "14:45", date: "2026-11-03T14:45:00-03:00" },
      { home: "Atlético Madrid", away: "Bayern", time: "17:00", date: "2026-11-03T17:00:00-03:00" },
      { home: "Bodø/Glimt", away: "Lille", time: "17:00", date: "2026-11-03T17:00:00-03:00" },
      { home: "Barcelona", away: "Aston Villa", time: "17:00", date: "2026-11-03T17:00:00-03:00" },
      { home: "Feyenoord", away: "Inter", time: "17:00", date: "2026-11-03T17:00:00-03:00" },
      { home: "LASK", away: "Slovan", time: "17:00", date: "2026-11-03T17:00:00-03:00" },
      { home: "Man Utd", away: "Roma", time: "17:00", date: "2026-11-03T17:00:00-03:00" },
      { home: "Villarreal", away: "PSG", time: "17:00", date: "2026-11-03T17:00:00-03:00" },

      // 04/11/2026
      { home: "AEK", away: "Real Madrid", time: "14:45", date: "2026-11-04T14:45:00-03:00" },
      { home: "Fenerbahçe", away: "Liverpool", time: "14:45", date: "2026-11-04T14:45:00-03:00" },
      { home: "Dortmund", away: "Real Betis", time: "17:00", date: "2026-11-04T17:00:00-03:00" },
      { home: "Porto", away: "Napoli", time: "17:00", date: "2026-11-04T17:00:00-03:00" },
      { home: "PSV", away: "Club Brugge", time: "17:00", date: "2026-11-04T17:00:00-03:00" },
      { home: "Leipzig", away: "Man City", time: "17:00", date: "2026-11-04T17:00:00-03:00" },
      { home: "Lens", away: "Como", time: "17:00", date: "2026-11-04T17:00:00-03:00" },
      { home: "Slavia Praha", away: "Arsenal", time: "17:00", date: "2026-11-04T17:00:00-03:00" },
      { home: "Viking", away: "Sabah", time: "17:00", date: "2026-11-04T17:00:00-03:00" },
    ];

    for (const m of round4Matches) {
      const homeId = getTeam(m.home);
      const awayId = getTeam(m.away);
      const homeTeam = uclTeamsDefs.find((t) => uclTeamMap.get(t.name) === homeId)!;
      const stInfo = CLUB_STADIUMS[homeTeam.name] || { stadium: "Estádio Europeu", city: "Europa" };
...
// ─── Rodadas 35 a 38 (Encerramento) — Brasileirão Série B 2026 ───────────────
export const seedSerieBRounds35to38 = mutation({
  args: {},
  handler: async (ctx) => {
    let serieB = await ctx.db
      .query("leagues")
    ...
    const TEAM_HOME_STADIUM: Record<string, string> = {
      ...
      "avai": "Ressacada",
      "vila nova": "OBA",
      "operario pr": "Germano Krüger",
      "ceara": "Castelão (CE)",
      "goias": "Hailé Pinheiro (Serrinha)",
      "nautico": "Estádio dos Aflitos",
      "athletic": "Arena Sicredi",
      "cuiaba": "Arena Pantanal",
      "botafogo sp": "Arena Nicnet (Santa Cruz)",
      "sao bernardo": "Primeiro de Maio",
      ...
      "fortaleza": "Castelão (CE)",
    };

    const allStadiums = await ctx.db.query("stadiums").collect();
    const findStadiumForTeam = (teamName: string, teamStadiumId?: Id<"stadiums">) => {
      if (teamStadiumId) {
        const found = allStadiums.find((s) => s._id === teamStadiumId);
        if (found) return found;
      }
      const n = normTeam(teamName);
      const targetStadium = TEAM_HOME_STADIUM[n];
      if (targetStadium) {
        const found = allStadiums.find(
          (s) => s.name.toLowerCase() === targetStadium.toLowerCase() || clean(s.name) === clean(targetStadium)
        );
        if (found) return found;
      }
      throw new Error(`Estádio oficial não encontrado para o mandante: ${teamName}`);
    };
    ...
    const fixtures: MatchDef[] = [
      // R35 (2026-10-24)
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "Ponte Preta", away: "Fortaleza" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "São Bernardo", away: "Vila Nova" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "América-MG", away: "Cuiabá" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "Operário-PR", away: "Athletic Club" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "Ceará", away: "Goiás" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "Atlético-GO", away: "Novorizontino" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "Avaí", away: "Botafogo-SP" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "Sport", away: "Criciúma" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "CRB", away: "Londrina" },
      { round: 35, date: "2026-10-24T16:00:00-03:00", home: "Juventude", away: "Náutico" },

      // R36 (2026-10-31)
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Botafogo-SP", away: "Sport" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Novorizontino", away: "Operário-PR" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Athletic Club", away: "Ceará" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Londrina", away: "América-MG" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Fortaleza", away: "Atlético-GO" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Goiás", away: "CRB" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Criciúma", away: "Ponte Preta" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Náutico", away: "Avaí" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Cuiabá", away: "São Bernardo" },
      { round: 36, date: "2026-10-31T16:00:00-03:00", home: "Vila Nova", away: "Juventude" },

      // R37 (2026-11-07)
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Botafogo-SP", away: "Londrina" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Novorizontino", away: "Fortaleza" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Athletic Club", away: "Atlético-GO" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Operário-PR", away: "Sport" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Ceará", away: "América-MG" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Goiás", away: "Ponte Preta" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Avaí", away: "São Bernardo" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Náutico", away: "CRB" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Cuiabá", away: "Juventude" },
      { round: 37, date: "2026-11-07T16:00:00-03:00", home: "Vila Nova", away: "Criciúma" },

      // R38 (2026-11-14)
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "Ponte Preta", away: "Operário-PR" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "São Bernardo", away: "Athletic Club" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "América-MG", away: "Avaí" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "Londrina", away: "Náutico" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "Fortaleza", away: "Vila Nova" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "Atlético-GO", away: "Cuiabá" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "Criciúma", away: "Novorizontino" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "Sport", away: "Goiás" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "CRB", away: "Ceará" },
      { round: 38, date: "2026-11-14T16:00:00-03:00", home: "Juventude", away: "Botafogo-SP" },
    ];

    // Busca partidas existentes das rodadas 35 a 38 na Série B para evitar duplicatas
    const existingMatches = await ctx.db
      .query("matches")
      .withIndex("by_league", (q) => q.eq("leagueId", serieB!._id))
      .collect();
    ...
    for (const f of fixtures) {
      ...
      const homeTeam = findTeam(f.home);
      const awayTeam = findTeam(f.away);
      const stadium = findStadiumForTeam(f.home, (homeTeam as any).stadiumId);
      const timeMs = new Date(f.date).getTime();
      const statusShort = "16:00";
    ...
    // Contagem total de partidas da Série B após inserção
    ...
    return {
      ...
      totalInserted: inserted,
      totalSkipped: skipped,
      totalSerieBMatches: finalMatches.length,
      perRoundStats,
    };
  },
});
